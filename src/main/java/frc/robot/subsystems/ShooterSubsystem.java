...
public class ShooterSubsystem extends SubsystemBase{
    ...
    // The velocity that we are going to shoot at. This may need to be modified realtime.
    public double rpmSetpoint = 100;
  ...
  private void initPidShoot(){
    ...
    // Disable the motor until there is a ShootCommand
